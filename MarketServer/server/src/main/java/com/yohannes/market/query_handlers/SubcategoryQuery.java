...
public class SubcategoryQuery {
    ...
    public Future<RowSet<Row>> fetchSubcategories(String username, String category_name) {
        return client.preparedQuery("SELECT * FROM subcategories WHERE username = $1 AND category_name = $2")
                .execute(Tuple.of(username, category_name));
    }
