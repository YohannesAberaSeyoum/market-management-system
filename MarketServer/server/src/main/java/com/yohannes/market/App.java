...
public class App {
        ...
        public static void main(String[] args) {
                ...
                router.route().handler(CorsHandler.create().allowedMethod(HttpMethod.GET).allowedMethod(HttpMethod.POST)
                                .allowedMethod(HttpMethod.PATCH).allowedMethod(HttpMethod.DELETE));
                ...
                router.patch("/category/:name")
                                .handler(routingContext -> categoryHandler.updateCategory(routingContext));
                router.delete("/category/:name")
                                .handler(routingContext -> categoryHandler.deleteCategory(routingContext));
                ...
                router.patch("/product/:category/:subcategory/:name")
                                .handler(routingContext -> productHandler.updateProduct(routingContext));
                router.delete("/product/:category/:subcategory/:name")
