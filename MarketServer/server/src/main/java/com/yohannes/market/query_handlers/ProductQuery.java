...
public class ProductQuery {
        ...
        public Future<RowSet<Row>> createProduct(String username, String category_name, String subcategory_name,
                ...
                return client
                                ...
                                .execute(Tuple.of(username, category_name, subcategory_name, name, description,
                                                quantity));
        }

        public Future<RowSet<Row>> getProduct(String username, String category_name, String subcategory_name,
                        String name) {
                return client
                                .preparedQuery(
        ...
        public Future<RowSet<Row>> updateProduct(String pName, String pCategoryName, String pSubcategoryName,
                ...
                return client
                                .preparedQuery(
                                                "UPDATE products SET name = $1, description = $2, category_name = $3, subcategory_name = $4, quantity = $5 WHERE name = $6 AND username = $7 AND category_name = $8 AND subcategory_name = $9")
                                .execute(Tuple.of(name, description, category_name, subcategory_name, quantity, pName,
                                                username,
                                                pCategoryName, pSubcategoryName));
        }
